...
\faIcon{github}/#1}}
\newcommand{\ttul}[2]{\bgroup\markoverwith{\textcolor{cyan}{\hdashrule[-0.8ex]{1mm}{2.1pt}{1pt}}}\ULon{\href{#2}{#1}}}
\newcommand{\ctt}[3][\#]{\pdftooltip{\ttul{#2}{#1}}{#3}}
...
\resumeItemListEnd
  ...
  \resumeSubItem{Languages}{
    ...
    \ctt{React}{6 months professional experience from Nth Cycle as well as the Grave Finder project from high school.acrobat },
  ...
  Docker}{\ghlink{automated\_docking\_script}}{Python, Schrodinger, Slurm,
